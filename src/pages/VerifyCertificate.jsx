...
export default function VerifyCertificate() {
  ...
  return (
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-wine-50/30">
        {/* Header */}
        <div className="bg-white border-b border-gray-200">
          <div className="max-w-3xl mx-auto px-4 py-4 flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <img src="/favicon-wine.svg" className="h-7 w-7" alt="Logo" />
        ...
        <div className="max-w-xl mx-auto px-4 py-12">
          <div className="text-center mb-8">
            <div className="w-14 h-14 bg-wine-100 rounded-full flex items-center justify-center mx-auto mb-4">
              <Award className="h-7 w-7 text-wine-600" />
            </div>
            ...
            <div className="flex gap-2">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full pl-9 pr-4 py-3 border border-gray-300 rounded-xl text-sm focus:ring-2 focus:ring-wine-500 focus:border-wine-500 font-mono"
                />
              </div>
              <button
                type="submit"
                disabled={loading || !code.trim()}
                className="px-6 py-3 bg-wine-600 text-white text-sm font-medium rounded-xl hover:bg-wine-700 transition-colors disabled:opacity-50"
              >
            ...
            <div className={`rounded-xl border-2 p-6 ${
              ...
              {result ? (
                <div className="text-center">
                  <CheckCircle className="h-12 w-12 text-wine-500 mx-auto mb-3" />
                  <h2 className="text-lg font-bold text-wine-900 mb-1">Certificate Verified</h2>
                  <p className="text-sm text-wine-700 mb-4">This is a valid certificate issued by The FastTrack Madrasah.</p>
                  ...
                  <div className="bg-white rounded-lg p-4 text-left space-y-3">
                    ...
                    <div className="flex gap-6">
                      <div>
                        ...
                        <div className="font-bold text-wine-600 text-lg">{Number(result.weighted_total).toFixed(1)}%</div>
                      </div>
                      <div>
