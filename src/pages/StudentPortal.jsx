              ...
              <Card key={enrollment.id} className="border-l-4 border-l-emerald-600">
                ...
                <div className="mb-6">
                  ...
                  <p className="text-xs text-gray-500">
                    {currentMilestone.weeksCompleted} of {currentMilestone.weeksInMilestone} weeks completed
                  </p>
                </div>
                  ...
                  <div className="relative px-2 sm:px-4">
                    <div className="flex justify-between items-start">
                      {(isTajweed ? TAJWEED_MILESTONES : EAIS_MILESTONES).map((milestone, index) => {
                        ...
                        const totalCount = isTajweed ? 6 : 8;
                        ...
                        return (
                          <div key={milestone.id} className="flex flex-col items-center relative" style={{ flex: 1 }}>
                            ...
                            {/* Milestone Circle */}
                            <div
                              className={`w-8 h-8 rounded-full flex items-center justify-center font-semibold text-xs border-2 transition-all z-10 ${
                                isCompleted
                            ...
                            {/* Milestone Name - hidden on mobile for space */}
                            <div className="mt-2 text-center hidden md:block max-w-[80px]">
