...
const BlogAdmin = () => {
          ...
          <div className="text-center mb-8">
            <Link to="/" className="inline-flex items-center gap-2 hover:opacity-80 transition-opacity mb-4">
              ...
              <div className="flex flex-col leading-none -space-y-1">
                ...
                <span className="text-base sm:text-lg font-bold text-gray-900" style={{letterSpacing: "0.44em", marginRight: "-0.44em"}}>Madrasah</span>
              </div>
            </Link>
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <Helmet><title>Blog Admin | The FastTrack Madrasah</title></Helmet>
      {/* Navigation Bar */}
            ...
            <Link to="/" className="flex items-center gap-2 hover:opacity-80 transition-opacity">
              ...
              <div className="flex flex-col leading-none -space-y-1">
                <div className="flex flex-col leading-none -space-y-1">
                  ...
                  <span className="text-xs sm:text-sm font-semibold text-gray-900" style={{letterSpacing: "0.44em", marginRight: "-0.44em"}}>Madrasah</span>
                </div>
