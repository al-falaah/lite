...
const TiptapEditor = ({ value, onChange, placeholder, useBlogStyle = false }) => { // eslint-disable-line no-unused-vars
  ...
  return (
    <div className="border border-gray-300 rounded-lg overflow-hidden focus-within:border-emerald-600 transition-colors bg-white">
      {lossWarning && (
      ...
      <div className="flex flex-wrap items-center gap-0.5 px-2 py-1.5 border-b border-gray-200 bg-gray-50">
        ...
        <ToolbarButton title="Tip callout" active={editor.isActive('tipCallout')}
        ...
        <ToolbarButton title="Arabic prose (right-aligned)" active={editor.isActive('arabicProse')}
        ...
        <div className="ml-auto">
          <ToolbarButton title={showHtml ? 'Visual editor' : 'HTML source'} active={showHtml}
      ...
      {showHtml ? (
        ...
        <EditorContent
          ...
          className="tiptap-lesson-editor prose max-w-none p-4 min-h-[300px]
            ...
            [&_.tip]:bg-blue-50 [&_.tip]:border-l-2 [&_.tip]:border-blue-400 [&_.tip]:px-4 [&_.tip]:py-3 [&_.tip]:my-4 [&_.tip]:rounded-r-md"
        />
      )}
